...
export type ActivityLogPage = { data: ActivityLog[]; page: number }
...
export function useActivityLogs(
  groupId: string,
  enabled = true
): UseInfiniteQueryResult<{ pages: ActivityLogPage[]; pageParams: number[] }, Error> {
  ...
  return useInfiniteQuery({
    ...
    initialPageParam: 0,
    getNextPageParam: (lastPage: ActivityLogPage) => {
